Level1 = {
    assets = {
        ...
        [7] = { type="texture", id = "collision-boundingBox", file = "./assets/images/collision-texture.png"},
        [8] = { type="texture", id = "radar-image", file = "./assets/images/radar.png"},
        [9] = { type="texture", id = "tank-texture-big-right", file = "./assets/images/tank-big-right.png"}
    },
    map = {
